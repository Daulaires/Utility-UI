...
auto ImGuiContainer::init(void) -> void {
    ...
    this->window = ::CreateWindowW(this->windowClass.lpszClassName, L"Test", WS_BORDER, 100, 100, 800, 400, nullptr, nullptr, this->windowClass.hInstance, nullptr);
...
auto ImGuiContainer::setAresStyles(void) -> void {
    ...
    colors[ImGuiCol_HeaderActive] = ImVec4{ 0.24f, 0.24f, 0.24f, 1.0f };

    // Buttons
    colors[ImGuiCol_Button] = ImVec4{ 0.2f, 0.2f, 0.2f, 1.0f };
    colors[ImGuiCol_ButtonHovered] = ImVec4{ 0.27f, 0.27f, 0.27f, 1.0f };
    ...
    // Tabs
    colors[ImGuiCol_Tab] = ImVec4{ 0.24f, 0.24f, 0.24f, 1.0f };
    colors[ImGuiCol_TabHovered] = ImVec4{ 0.32f, 0.32f, 0.32f, 1.0f };
    colors[ImGuiCol_TabActive] = ImVec4{ 0.28f, 0.28f, 0.28f, 1.0f };
    colors[ImGuiCol_TabUnfocused] = ImVec4{ 0.24f, 0.24f, 0.24f, 1.0f };
    colors[ImGuiCol_TabUnfocusedActive] = ImVec4{ 0.24f, 0.24f, 0.24f, 1.0f };

    // Title
    colors[ImGuiCol_TitleBg] = ImVec4{ 0.24f, 0.24f, 0.24f, 1.0f };
    colors[ImGuiCol_TitleBgActive] = ImVec4{ 0.24f, 0.24f, 0.24f, 1.0f };
    colors[ImGuiCol_TitleBgCollapsed] = ImVec4{ 0.24f, 0.24f, 0.24f, 1.0f };

    // Scrollbar
    colors[ImGuiCol_ScrollbarBg] = ImVec4{ 0.13f, 0.13f, 0.13f, 1.0f };
    colors[ImGuiCol_ScrollbarGrab] = ImVec4{ 0.2f, 0.2f, 0.2f, 1.0f };
    colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4{ 0.27f, 0.27f, 0.27f, 1.0f };
    colors[ImGuiCol_ScrollbarGrabActive] = ImVec4{ 0.32f, 0.32f, 0.32f, 1.0f };

    // Separator
    colors[ImGuiCol_Separator] = ImVec4{ 0.44f, 0.44f, 0.44f, 1.0f };
    colors[ImGuiCol_SeparatorHovered] = ImVec4{ 0.74f, 0.58f, 0.98f, 1.0f };
    colors[ImGuiCol_SeparatorActive] = ImVec4{ 0.84f, 0.58f, 1.0f, 1.0f };

    // Resize Grip
    colors[ImGuiCol_ResizeGrip] = ImVec4{ 0.44f, 0.44f, 0.44f, 0.29f };
